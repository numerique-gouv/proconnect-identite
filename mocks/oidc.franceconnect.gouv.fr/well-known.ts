...
import { FRANCECONNECT_ISSUER } from "../../src/config/env";

export default {
  acr_values_supported: ["eidas1"],
  authorization_endpoint: `${FRANCECONNECT_ISSUER}/authorize`,
  ...
  token_endpoint: `${FRANCECONNECT_ISSUER}/token`,
  request_object_signing_alg_values_supported: ["ES256", "RS256", "HS256"],
  request_parameter_supported: false,
  request_uri_parameter_supported: true,
  require_request_uri_registration: true,
  userinfo_endpoint: `${FRANCECONNECT_ISSUER}/userinfo`,
  userinfo_signing_alg_values_supported: ["HS256", "ES256", "RS256"],
  revocation_endpoint: `${FRANCECONNECT_ISSUER}/token/revocation`,
